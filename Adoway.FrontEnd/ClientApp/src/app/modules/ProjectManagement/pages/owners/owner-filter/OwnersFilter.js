...
export function OwnersFilter({ listLoading }) {
    // Owners UI Context
    ...
    const applyFilter = (values) => {
        const newQueryParams = prepareFilter(ownersUIProps.queryParams, values);
        if (!isEqual(newQueryParams, ownersUIProps.queryParams)) {
            newQueryParams.pageNumber = 1;
            // update list by queryParams
            ownersUIProps.setQueryParams(newQueryParams);
        }
    };
