...
export function TeleVendorsFilter({ listLoading }) {
    ...
    const applyFilter = (values) => {
        const newQueryParams = prepareFilter(teleVendorsUIProps.queryParams, values);
        if (!isEqual(newQueryParams, teleVendorsUIProps.queryParams)) {
            newQueryParams.pageNumber = 1;
            // update list by queryParams
            teleVendorsUIProps.setQueryParams(newQueryParams);
        }
    };
