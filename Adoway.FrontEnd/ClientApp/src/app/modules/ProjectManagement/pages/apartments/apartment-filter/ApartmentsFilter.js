...
export function ApartmentsFilter({ listLoading }) {
    ...
    const applyFilter = (values) => {
        const newQueryParams = prepareFilter(apartmentsUIProps.queryParams, values);
        if (!isEqual(newQueryParams, apartmentsUIProps.queryParams)) {
            newQueryParams.pageNumber = 1;
            // update list by queryParams
            apartmentsUIProps.setQueryParams(newQueryParams);
        }
    };
