...
export function MeetingRoomsFilter({ listLoading }) {
    ...
    const applyFilter = (values) => {
        const newQueryParams = prepareFilter(meetingRoomsUIProps.queryParams, values);
        if (!isEqual(newQueryParams, meetingRoomsUIProps.queryParams)) {
            newQueryParams.pageNumber = 1;
            // update list by queryParams
            meetingRoomsUIProps.setQueryParams(newQueryParams);
        }
    };
