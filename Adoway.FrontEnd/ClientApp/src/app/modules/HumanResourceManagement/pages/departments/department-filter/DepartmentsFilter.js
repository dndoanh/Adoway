...
export function DepartmentsFilter({ listLoading }) {
    ...
    const applyFilter = (values) => {
        const newQueryParams = prepareFilter(departmentsUIProps.queryParams, values);
        if (!isEqual(newQueryParams, departmentsUIProps.queryParams)) {
            newQueryParams.pageNumber = 1;
            // update list by queryParams
            departmentsUIProps.setQueryParams(newQueryParams);
        }
    };
